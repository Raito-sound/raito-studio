...
<link rel="icon" href="/favicon.svg" type="image/svg+xml"><link rel="stylesheet" href="/site.css?v=tools-seo-20260907"><link rel="stylesheet" href="/apps.css?v=tools-seo-20260907">
<script type="application/ld+json">{json.dumps(data, ensure_ascii=False).replace('<', '&lt;')}</script></head>
<body id="top" class="app-page {app or 'tools-hub'}"><a class="skip-link" href="#main">{'本文へ' if is_ja else 'Skip to content'}</a>
<header class="site-header"><a class="brand" href="/" aria-label="Raito.studio home"><img src="/assets/raito-logo.svg" alt="Raito / 来兎" width="84" height="44"></a><nav aria-label="{'メインナビゲーション' if is_ja else 'Primary navigation'}"><a href="/">Home</a><a href="/works/">Works</a><a href="{tools_path}" aria-current="{'page' if slug == 'tools' else 'false'}">Tools</a><a href="/press/?lang={'ja' if is_ja else 'en'}">Press</a></nav><a class="header-contact" href="/#contact">Contact ↗</a></header>
